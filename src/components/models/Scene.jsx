...
// console.log(nodes.getObjectByName('table_Material5001_0'));

// const tableMat= nodes.children[0];
...
console.log("texture",textureSelect);
  ...
  //   floorObj[textureSelect>=0 && componentSelect==4?textureSelect:0];
  //  },[componentSelect,textureSelect]);

  //  const texture= useTexture(loadingObj)
...
// const loadingObj2=cabinObj[textureSelect>=0 && componentSelect==2?textureSelect:0]
// const loadingObj2=useMemo(()=>{
    
//   floorObj[textureSelect>=0 && componentSelect==2?textureSelect:0];
//  },[componentSelect,textureSelect]);
 
// const cabTex=useTexture(loadingObj2);
...
// const loadingObj3=chairObj[textureSelect>=0 && componentSelect==0?textureSelect:0]
// const loadingObj3=useMemo(()=>{
    
//   floorObj[textureSelect>=0 && componentSelect==0?textureSelect:0];
//  },[componentSelect,textureSelect]);
 
// const chairTex=useTexture(loadingObj3);
...
// const loadingObj4=tableObj[textureSelect>=0 && componentSelect==1?textureSelect:0]
// const loadingObj4=useMemo(()=>{
    
//   floorObj[textureSelect>=0 && componentSelect==1?textureSelect:0];
//  },[componentSelect,textureSelect]);
 
// const tableTex=useTexture(loadingObj4);
    ...
    <group {...props}  dispose={null}>
      <group scale={0.01}>
        <group position={[388.469, 117.552, -211.434]} rotation={[-Math.PI / 2, 0.148, 0]} scale={[2.712, 31.279, 31.279]} castShadow >
          ...
          >
{/* <Decal map={texture} scale={100} anisotropy={16} depthTest={true} depthWrite={true} /> */}

            </mesh>
          <mesh geometry={nodes.painting_Material011_0.geometry} material={materials['Material.011']} castShadow receiveShadow>
{/* <Decal map={texture} scale={100} anisotropy={16} depthTest={true} depthWrite={true}  position={0,-10,0}/> */}
...
{/* <Decal map={texture} scale={[80.747, 80.747, 10.763]} anisotropy={16} depthTest={true} depthWrite={true}  position={0,0,0}/> */}
